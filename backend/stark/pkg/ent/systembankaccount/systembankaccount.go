...
const (
	// Label holds the string label denoting the systembankaccount type in the database.
	Label = "system_bank_account"
	...
	// Table holds the table name of the systembankaccount in the database.
	Table = "system_bank_accounts"
)

// Columns holds all SQL columns for systembankaccount fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
