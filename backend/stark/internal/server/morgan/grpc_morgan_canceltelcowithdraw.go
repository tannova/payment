...
func (s *morganServer) CancelTelcoWithdraw(ctx context.Context, request *stark.CancelTelcoWithdrawRequest) (*stark.CancelTelcoWithdrawReply, error) {
	...
	return &stark.CancelTelcoWithdrawReply{}, nil
}
